...
//! - [`pdk`] — PDK-shared types and library detection. The behavioural-model
//!   parsing and AIG-decomposition primitives live in the standalone
//!   `cell_decomp` crate (`crates/cell-decomp`).
