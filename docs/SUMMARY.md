...
- [Spike — Architecture documentation redesign](spikes/architecture-doc-redesign.md)
  - [Worked example — Architecture map](architecture/README.md)
  - [Worked example — Cosim runtime](architecture/cosim-runtime.md)
