# Decision 0004 — Private PDK testing track
...
The timing IR (Decision 0002) makes this feasible: converter output and diff results can be checked in as fixtures where they contain no PDK-licensed data. Expected behaviour can be asserted in terms of IR structure rather than in terms of specific cell timings that would leak characterization data.
...
- Decision 0002 — timing IR (enables portable fixtures).
