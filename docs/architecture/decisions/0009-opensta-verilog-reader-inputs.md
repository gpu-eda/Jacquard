# Decision 0009 — OpenSTA Verilog reader input constraints
...
- Decision 0001 — OpenSTA as oracle and sole STA path (the upstream
  tool whose constraints these are).
- Decision 0006 — SDF preprocessing model (the surrounding flow that
